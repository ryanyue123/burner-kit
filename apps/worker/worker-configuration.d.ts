/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 75b4600cead7e81efc471efd9b65b193)
// Runtime types generated with workerd@1.20260401.1 2026-04-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "UserChannel";
  }
  interface Env {
    DB: D1Database;
    CODE_EXTRACTION_QUEUE: Queue;
    AI: Ai;
    BETTER_AUTH_URL: "http://localhost:8787";
    EXTENSION_ORIGIN: "chrome-extension://gjkdmhmhmoahlkpcmkedpdjpahjkciip";
    USER_CHANNEL: DurableObjectNamespace<import("./src/index").UserChannel>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "EXTENSION_ORIGIN">
  > {}
}
